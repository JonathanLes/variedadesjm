...
mixin _$Marca {
  ...
  String get nombreMarca => throw _privateConstructorUsedError;
...
abstract class $MarcaCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String nombreMarca});
}
...
class _$MarcaCopyWithImpl<$Res, $Val extends Marca>
  ...
  @override
  $Res call({Object? id = null, Object? nombreMarca = null}) {
    return _then(
      _value.copyWith(
            id: null == id
                ? _value.id
                : id // ignore: cast_nullable_to_non_nullable
                      as String,
            nombreMarca: null == nombreMarca
                ? _value.nombreMarca
                : nombreMarca // ignore: cast_nullable_to_non_nullable
                      as String,
          )
          as $Val,
    );
...
/// @nodoc
@JsonSerializable()
class _$MarcaImpl extends _Marca {
  const _$MarcaImpl({required this.id, required this.nombreMarca}) : super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nombreMarca, nombreMarca) ||
                other.nombreMarca == nombreMarca));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, nombreMarca);
...
abstract class _Marca extends Marca {
  const factory _Marca({
    required final String id,
    required final String nombreMarca,
  }) = _$MarcaImpl;
  const _Marca._() : super._();
