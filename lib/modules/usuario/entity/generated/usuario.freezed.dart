...
mixin _$Usuario {
  ...
  String get pinCifrado => throw _privateConstructorUsedError;
  UsuarioRol get rol => throw _privateConstructorUsedError;
...
abstract class $UsuarioCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String nombre, String pinCifrado, UsuarioRol rol});
}
      ...
      _value.copyWith(
            ...
            nombre: null == nombre
                ...
                : nombre // ignore: cast_nullable_to_non_nullable
                      as String,
            pinCifrado: null == pinCifrado
                ? _value.pinCifrado
                : pinCifrado // ignore: cast_nullable_to_non_nullable
                      as String,
            rol: null == rol
                ? _value.rol
...
class _$UsuarioImpl extends _Usuario {
  ...
  @override
  String toString() {
    return 'Usuario(id: $id, nombre: $nombre, pinCifrado: $pinCifrado, rol: $rol)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pinCifrado, pinCifrado) ||
                other.pinCifrado == pinCifrado) &&
            (identical(other.rol, rol) || other.rol == rol));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, nombre, pinCifrado, rol);
...
abstract class _Usuario extends Usuario {
  const factory _Usuario({
    ...
    required final String pinCifrado,
    required final UsuarioRol rol,
  }) = _$UsuarioImpl;
